...
var isOutOfBoundary = function isOutOfBoundary(
  left,
  top,
  width,
  height,
...
var Rect = /*#__PURE__*/ (function (_PureComponent) {
  ...
  function Rect(props) {
    ...
    _this.state = {
      isFocused:
        (_props$defaultFocus = props.defaultFocus) !== null &&
        _props$defaultFocus !== void 0
          ? _props$defaultFocus
          : false
    }
    return _this
...
function ResizableRect(_ref) {
  ...
  var _ref$rotatable = _ref.rotatable,
    ...
    parentRotateAngle =
      _ref$parentRotateAngl === void 0 ? 0 : _ref$parentRotateAngl,
    ...
    defaultRotateAngle =
      _ref$defaultRotateAng === void 0 ? 0 : _ref$defaultRotateAng,
  ...
  var _useState = useState(
      (_initValues$top =
        initValues === null || initValues === void 0
          ? void 0
          : initValues.top) !== null && _initValues$top !== void 0
        ? _initValues$top
        : 10
    ),
  ...
  var _useState3 = useState(
      (_initValues$left =
        initValues === null || initValues === void 0
          ? void 0
          : initValues.left) !== null && _initValues$left !== void 0
        ? _initValues$left
        : 10
    ),
  ...
  var _useState5 = useState(
      (_initValues$width =
        initValues === null || initValues === void 0
          ? void 0
          : initValues.width) !== null && _initValues$width !== void 0
        ? _initValues$width
        : 100
    ),
  ...
  var _useState7 = useState(
      (_initValues$height =
        initValues === null || initValues === void 0
          ? void 0
          : initValues.height) !== null && _initValues$height !== void 0
        ? _initValues$height
        : 100
    ),
